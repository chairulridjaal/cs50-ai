    ...
    def add_knowledge(self, cell, count):
        ...
        for row in range(cell[0] - 1, cell[0] + 2):
            for col in range(cell[1] - 1, cell[1] + 2):
                if (row, col) == cell or not (0 <= row < self.height and 0 <= col < self.width):
                    continue
        ...
        newSentence = Sentence(undetermined, count - mines_count)
        ...
        for sentence in self.knowledge:
            if newSentence.cells.issubset(sentence.cells) and sentence.count > 0 and newSentence.count > 0 and newSentence != sentence:
                ...
                newSensub = Sentence(list(newSubSet), sentence.count - newSentence.count)
                self.knowledge.append(newSensub)
